...
const translations = {
  en: {
    ...
    statsAndManagement: 'Stats & System Management',
    ...
    deleteUserConfirmMsg: 'This will permanently delete the user and all their data.',
    deleteFeedbackConfirmTitle: 'Delete Feedback',
    deleteFeedbackConfirmMsg: 'Are you sure you want to delete this feedback?',
    broadcastSuccess: 'Email sent successfully!',
    userInfo: 'User Info',
    role: 'Role',
    joinDate: 'Join Date',
    action: 'Action',
    ...
    content: 'Content',
    date: 'Date',
    adminZoneAccessDenied: 'This is an untouchable zone :)',
    adminZoneDesc: 'Dave manages this area',
  ...
  vi: {
    ...
    errorSendingEmail: 'Lỗi gửi mail',
    adminDashboard: 'Bảng điều khiển',
    statsAndManagement: 'Thống kê & Quản lý hệ thống',
    sendBroadcast: 'Gửi thông báo',
    totalUsers: 'Tổng Users',
    totalNotes: 'Tổng Notes',
    totalFeedbacks: 'Tổng Phản hồi',
    growth: 'Tăng trưởng',
    newUser: 'User mới',
    newNote: 'Note mới',
    genderStats: 'Giới tính',
    searchUser: 'Tìm user...',
    deleteUserConfirmTitle: 'Xóa người dùng',
    deleteUserConfirmMsg: 'Hành động này sẽ xóa vĩnh viễn user và toàn bộ dữ liệu.',
    deleteFeedbackConfirmTitle: 'Xóa phản hồi',
    deleteFeedbackConfirmMsg: 'Bạn có chắc chắn muốn xóa phản hồi này?',
    broadcastSuccess: 'Đã gửi email thành công!',
    ...
    content: 'Nội dung',
    date: 'Ngày',
    adminZoneAccessDenied: 'Đây là vùng không thể chạm vào :)',
    adminZoneDesc: 'Dave quản lý khu này',
